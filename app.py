...
# ================== HEADER ==================
# ================== HEADER ==================
# First, test with a simple HTML to see if it renders
st.markdown("<h1 style='color: red;'>TEST - If this is red, HTML works</h1>", unsafe_allow_html=True)
...
<style>
    ...
    .factguard-header {
        ...
        box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4), 0 0 60px rgba(59, 130, 246, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1);
...
<div class='factguard-header'>
    <div class='logo-container'>
        <!-- Use direct file path with forward slashes for Windows -->
...
with col2:
    ...
    <div class='metric-box'>
        <div style='font-size: 0.9rem; color: #94A3B8;'>NewsAPI</div>
        <div style='font-size: 1.5rem; font-weight: bold; color: {'#10B981' if NEWSAPI_KEY else '#F59E0B'};'>
            {'✅ Active' if NEWSAPI_KEY else '⚠️ Demo'}
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    st.markdown(f"""
    <div class='metric-box'>
        <div style='font-size: 0.9rem; color: #94A3B8;'>ML Models</div>
        <div style='font-size: 1.5rem; font-weight: bold; color: {'#10B981' if ML_AVAILABLE else '#EF4444'};'>
            {'✅ Active' if ML_AVAILABLE else '❌ Disabled'}
        </div>
    </div>
    """, unsafe_allow_html=True)
