"""
NeuraVerify AI - Advanced Fake News Detection System
...
st.set_page_config(
    page_title="NeuraVerify AI - Truth Detector",
    page_icon="🔍",
    layout="wide",
...
with tab2:
    ...
    metrics = [
        ("⏱️", "2.1s", "Avg Analysis Time", "#6366F1"),
...
with tab3:
    st.markdown("<div class='glass-card'><h2 style='margin-top: 0; color: #1F2937;'>⚙️ SYSTEM ARCHITECTURE</h2></div>", unsafe_allow_html=True)
...
<div style='text-align: center; padding: 40px 0 20px 0; color: white;'>
    ...
    <p style='font-size: 0.9em; margin-top: 10px; opacity: 0.8;'>
        Prepared by: <strong>Hadia Akbar (042)</strong> | <strong>Naira Shahid (062)</strong>
    </p>
</div>
""", unsafe_allow_html=True)